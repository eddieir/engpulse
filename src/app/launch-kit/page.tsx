...
const posts = [
  {
    ...
    hook: "I spent 2 years as a CTO asking the same question every week: \"How is the team doing?\"",
    body: `Every Monday I'd ask my engineers for a status update. They'd send me a 500-word doc full of PR counts, deployment stats, and technical jargon I had to translate before I could tell the CEO anything useful.

I was spending 3 hours every week turning raw engineering data into leadership language.

That's when I realized: the problem isn't that engineers don't communicate. The problem is that the tools we use for engineering visibility were built for engineers.
...
No jargon. No dashboards full of DORA metrics. Just clear answers to the questions every CTO and CEO actually needs.

If you're leading an engineering team and spending hours writing weekly reports manually — I'd love your feedback.
